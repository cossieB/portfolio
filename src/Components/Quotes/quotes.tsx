...
export default function Quotes() {
    ...
    return (
        <motion.main style={{ background: window.innerWidth > 768 ? `url(${background.src})` : mobileBG }} id="quoteContainer" className="container" variants={containerVariant} initial="start" animate="end" exit={'exit'}>
        ...
        <div style={{color}} id="quote-box" >
            ...
            <div id="quoteButtons">
                <div id="socialButtons">
                    ...
                    <a className="shareQuotes" title="Post on tumblr" href={`https://www.tumblr.com/widgets/share/tool?posttype=quote&tags=quotes&caption=${author}&content=${quote}&canonicalUrl=https%3A%2F%2Fcossie-91.web.app%2Fquotes`} target="_blank" rel="noreferrer" >
